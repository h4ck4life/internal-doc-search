...
| `FILE_QDRANT_MAX_RETRIES` | `3` | Retry attempts for a single-vector file-ingestion Qdrant write after timeout. Larger timed-out batches are split and retried automatically. |
